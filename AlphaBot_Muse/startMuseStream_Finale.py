...
# 0 = left ear, 1 = left forehead, 2 = right forehead, 3 = right ear
    ...
    def museConcentrazione(): #returns the incoming command to the alphabot for concentration
        ...
        return band_beta #command (W / ESCI) for the alphabot, if concentrated W then go ahead, otherwise EXIT, stand still
